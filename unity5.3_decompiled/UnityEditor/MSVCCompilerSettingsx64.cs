...
internal class MSVCCompilerSettingsx64 : ICompilerSettings
{
    ...
    public MSVCCompilerSettingsx64()
    {
        ...
        this.m_LibPaths = new string[] { Environment.ExpandEnvironmentVariables(@"%VS100COMNTOOLS%..\..\VC\lib\amd64"), @"C:\Program Files (x86)\Microsoft SDKs\Windows\v7.0A\Lib\x64" };
    }
