namespace UnityEditor
{
    ...
    internal class ModelImporterClipEditor : AssetImporterInspector
    {
        ...
        private void AnimationSettings()
        {
            ...
            {
                EditorGUILayout.PropertyField(this.m_ResampleCurves, styles.ResampleCurves, new GUILayoutOption[0]);
            }
            else
            {
        ...
        public void OnEnable()
        {
            ...
            this.m_ResampleCurves = base.serializedObject.FindProperty("m_ResampleRotations");
